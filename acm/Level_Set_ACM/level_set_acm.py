...
def active_contour_layer(elems, input_image_size, input_image_size_2 = None, nu = 5.0, mu = 0.2, iter_limit = 300, acm_dir=None, freq=None, gt=None, dice_scores=[], iou_scores=[], iterations=[]):
