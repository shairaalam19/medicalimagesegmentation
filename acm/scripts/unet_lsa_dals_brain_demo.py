...
acm_dir = os.path.abspath(os.path.join(cwd, '../Results/DALS_LSA/brain/unet_init_contour/gray'))
result = lsarh.run_lsa(image_path, gt_path, init_seg=init_seg_path, acm_dir=acm_dir, iter_lim=600)

print('Original Brain Demo With Updated Hyper-parameters')
print()
...
# --- Other image pre-processing techniques
