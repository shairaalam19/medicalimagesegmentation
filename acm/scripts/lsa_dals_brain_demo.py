...
if(True):
    ...
    #acm_dir = os.path.abspath(os.path.join(cwd, '../Results/DALS_LSA/brain/trivial_init_contour'))
    acm_dir = os.path.abspath(os.path.join(cwd, '../Results/DALS_LSA/brain/trivial_init_contour/abc'))
...
if(False):
    ...
    image_path = os.path.abspath(os.path.join(cwd, '../dals_demo_brain/img1_input.npy'))
    gt_path = os.path.abspath(os.path.join(cwd, '../dals_demo_brain/img1_label.npy'))
    #acm_dir = os.path.abspath(os.path.join(cwd, '../Results/DALS_LSA/brain/intermediate_init_contour'))
    acm_dir = os.path.abspath(os.path.join(cwd, '../Results/DALS_LSA/brain/intermediate_init_contour/abc'))
